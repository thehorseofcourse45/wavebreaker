...
const DEFS: Array[Dictionary] = [
	...
	{"id": "Sentinel", "name": "Sentinel", "group": "", "hp": 44,
		"scene": "res://scenes/enemy_sentinel.tscn", "slug": "sentinel",
		"hint": "Plants itself and shoots from a standstill, then relocates. Punish it while it walks."},
	{"id": "Phalanx", "name": "Phalanx", "group": "", "hp": 55,
		"scene": "res://scenes/enemy_phalanx.tscn", "slug": "phalanx",
		"hint": "Moves only on the cardinal axes. Strafe across its lane, never along it."},
	{"id": "Bomber", "name": "Bomber", "group": "", "hp": 30,
		"scene": "res://scenes/enemy_bomber.tscn", "slug": "bomber",
		"hint": "Sprints at you and detonates. Kill it at range -- its blast does not care who sets it off."},
	{"id": "Carrier", "name": "Carrier", "group": "", "hp": 95,
		"scene": "res://scenes/enemy_carrier.tscn", "slug": "carrier",
		"hint": "Slow courier that grows minis as it walks. It has to die before the wave can shrink."},
	{"id": "Skitterer", "name": "Skitterer", "group": "", "hp": 28,
		"scene": "res://scenes/enemy_skitterer.tscn", "slug": "skitterer",
		"hint": "Chases while healthy, bolts the moment it is hurt. Corner it or chase it down."},
	{"id": "Mirage", "name": "Mirage", "group": "", "hp": 40,
		"scene": "res://scenes/enemy_mirage.tscn", "slug": "mirage",
		"hint": "Blinks to a new spot every few seconds. Aim where it is going, not where it was."},
	{"id": "Bombardier", "name": "Bombardier", "group": "", "hp": 58,
		"scene": "res://scenes/enemy_bombardier.tscn", "slug": "bombardier",
		"hint": "Lobs slow, heavy shells from far away. Sidestep early -- the shell covers ground."},
	{"id": "Phantom", "name": "Phantom", "group": "", "hp": 46,
		"scene": "res://scenes/enemy_phantom.tscn", "slug": "phantom",
		"hint": "Phases untouchable, then solidifies to strike. Shoot only when it is opaque."},
	...
	{"id": "Elite Sentinel", "name": "Elite Sentinel", "group": "elites", "hp": 110,
		"scene": "res://scenes/enemy_sentinel.tscn", "slug": "elite_sentinel", "elite": true,
		"hint": "A turret behind a shield phase -- its firing rhythm and its shield share a clock."},
	{"id": "Elite Phalanx", "name": "Elite Phalanx", "group": "elites", "hp": 138,
		"scene": "res://scenes/enemy_phalanx.tscn", "slug": "elite_phalanx", "elite": true,
		"hint": "Grid-locked and shielded between lanes. Cross the lane while the cyan holds."},
	{"id": "Elite Bomber", "name": "Elite Bomber", "group": "elites", "hp": 75,
		"scene": "res://scenes/enemy_bomber.tscn", "slug": "elite_bomber", "elite": true,
		"hint": "The fuse runs behind a shield phase. Break the cyan or eat the blast on its terms."},
	{"id": "Elite Carrier", "name": "Elite Carrier", "group": "elites", "hp": 238,
		"scene": "res://scenes/enemy_carrier.tscn", "slug": "elite_carrier", "elite": true,
		"hint": "Grows minis from behind a shield phase. The shield is why it is the priority."},
	{"id": "Elite Skitterer", "name": "Elite Skitterer", "group": "elites", "hp": 70,
		"scene": "res://scenes/enemy_skitterer.tscn", "slug": "elite_skitterer", "elite": true,
		"hint": "Runs sooner, and the shield runs with it. Plan the corner before you shoot."},
	{"id": "Elite Mirage", "name": "Elite Mirage", "group": "elites", "hp": 100,
		"scene": "res://scenes/enemy_mirage.tscn", "slug": "elite_mirage", "elite": true,
		"hint": "Blinks on its own schedule behind a shield phase. Patience, then a burst."},
	{"id": "Elite Bombardier", "name": "Elite Bombardier", "group": "elites", "hp": 145,
		"scene": "res://scenes/enemy_bombardier.tscn", "slug": "elite_bombardier", "elite": true,
		"hint": "Shells you from behind a shield cycle. Dodge on its clock, close on its gap."},
	{"id": "Elite Phantom", "name": "Elite Phantom", "group": "elites", "hp": 115,
		"scene": "res://scenes/enemy_phantom.tscn", "slug": "elite_phantom", "elite": true,
		"hint": "Untouchable twice over: phase and shield never overlap -- learn which is up."},

	{"id": "Warden", "name": "Warden", "group": "bosses", "hp": 9000,
